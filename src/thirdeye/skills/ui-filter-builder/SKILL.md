...
Expected response:
```
{"platform": null, "cwd": null, "tags": ["refactor"], "since": null, "until": null, "status": "open", "order": "longest", "rationale": "Open sessions tagged refactor, ordered by longest duration."}
```
